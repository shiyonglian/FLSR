...
im_h = imread('head_GT[11-Our A+].bmp');
...
im_zero=uint8(zeros(276,276));%GNDÕº¥Û–°
im_zero(3:275,3:275)=im_h;
im=im_zero;
...
%
figure, imshow(im_gnd); title('face_crop504');

%imwrite(im_b, ['Bicubic Interpolation' '.bmp']);
imwrite(im_gnd, ['face_a+_crop' '.bmp']);
