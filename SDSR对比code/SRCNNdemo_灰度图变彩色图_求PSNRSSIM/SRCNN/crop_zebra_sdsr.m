...
im_zero=uint8(zeros(391,586));
im_zero(3:390,3:585)=im_h;
im=im_zero;
...
%
figure, imshow(im_gnd); title('zebra_crop504');

%imwrite(im_b, ['Bicubic Interpolation' '.bmp']);
imwrite(im_gnd, ['zebra_sdsr_504_gnd' '.bmp']);
